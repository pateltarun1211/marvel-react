...
// Functional Components to be used inside of our Sign In and Sign Up Components
...
const GoogleButton = (props:buttonProps) => {
    ...
    const signIn = async () => {
        ...
        // Storing authenticated use in a local variable
    ...
    const onSubmit = async (data:any, event: any) => {
        ...
        signInWithEmailAndPassword(auth, data.email, data.password)
            .then((userCredential) =>{
                ...
                navigate('/dashboard') //takes us to DashBoard on succesful signin
            })
            .catch((error) =>{
