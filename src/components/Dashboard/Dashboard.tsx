    ...
    return (
        <Box sx={{ display: 'flex' }} >
            ...
            >
                ...
                <Button sx={ myStyles.toolbar_button } onClick={handleDialogClickOpen}>Create New Superhero</Button>
                {/* Dialog Box Open */}
                <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby='form-dialog-title'>
                    <DialogTitle id='form-dialog-title'>Add New Superhero</DialogTitle>
                    <DialogContent>
                        <DialogContentText>Add A New Superhero</DialogContentText>
                            <HeroForm />
                    </DialogContent>
                    <DialogActions>
